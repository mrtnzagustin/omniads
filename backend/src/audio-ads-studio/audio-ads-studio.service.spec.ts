...
describe('AudioAdsStudioService', () => {
  let service: AudioAdsStudioService;
  let repository: Repository<AudioAd>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AudioAdsStudioService,
        {
          provide: getRepositoryToken(AudioAd),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<AudioAdsStudioService>(AudioAdsStudioService);
    repository = module.get<Repository<AudioAd>>(getRepositoryToken(AudioAd));
  });
