...
describe('WhiteLabelDashboardController', () => {
  let controller: WhiteLabelDashboardController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: WhiteLabelDashboardService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<WhiteLabelDashboardController>(WhiteLabelDashboardController);
