...
describe('WhiteLabelDashboardService', () => {
  let service: WhiteLabelDashboardService;
  let repository: Repository<WhiteLabelDashboard>;
  ...
  const mockEntity: Partial<WhiteLabelDashboard> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        WhiteLabelDashboardService,
        {
          provide: getRepositoryToken(WhiteLabelDashboard),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<WhiteLabelDashboardService>(WhiteLabelDashboardService);
    repository = module.get<Repository<WhiteLabelDashboard>>(getRepositoryToken(WhiteLabelDashboard));
  });
