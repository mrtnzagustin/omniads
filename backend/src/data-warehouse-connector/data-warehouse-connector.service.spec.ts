...
describe('DataWarehouseConnectorService', () => {
  let service: DataWarehouseConnectorService;
  let repository: Repository<DataWarehouseConnector>;
  ...
  const mockEntity: Partial<DataWarehouseConnector> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getRepositoryToken(DataWarehouseConnector),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<DataWarehouseConnectorService>(DataWarehouseConnectorService);
    repository = module.get<Repository<DataWarehouseConnector>>(getRepositoryToken(DataWarehouseConnector));
  });
