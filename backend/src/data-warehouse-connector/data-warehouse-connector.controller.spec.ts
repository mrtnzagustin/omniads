...
describe('DataWarehouseConnectorController', () => {
  let controller: DataWarehouseConnectorController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: DataWarehouseConnectorService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<DataWarehouseConnectorController>(DataWarehouseConnectorController);
