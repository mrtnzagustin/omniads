...
describe('AiConversationAdsBuilderService', () => {
  let service: AiConversationAdsBuilderService;
  let repository: Repository<ConversationAd>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AiConversationAdsBuilderService,
        {
          provide: getRepositoryToken(ConversationAd),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<AiConversationAdsBuilderService>(AiConversationAdsBuilderService);
    repository = module.get<Repository<ConversationAd>>(getRepositoryToken(ConversationAd));
  });
