...
@Controller('ai-conversation-ads-builder')
@UseGuards(JwtAuthGuard)
export class AiConversationAdsBuilderController {
  constructor(private readonly service: AiConversationAdsBuilderService) {}
