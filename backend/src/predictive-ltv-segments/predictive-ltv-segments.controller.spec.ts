...
describe('PredictiveLtvSegmentsController', () => {
  let controller: PredictiveLtvSegmentsController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: PredictiveLtvSegmentsService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<PredictiveLtvSegmentsController>(PredictiveLtvSegmentsController);
