...
describe('RetentionMarketingAutopilotService', () => {
  let service: RetentionMarketingAutopilotService;
  let repository: Repository<ChurnPrediction>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        RetentionMarketingAutopilotService,
        {
          provide: getRepositoryToken(ChurnPrediction),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<RetentionMarketingAutopilotService>(RetentionMarketingAutopilotService);
    repository = module.get<Repository<ChurnPrediction>>(getRepositoryToken(ChurnPrediction));
  });
