...
@Injectable()
export class RetentionMarketingAutopilotService {
  constructor(
    @InjectRepository(ChurnPrediction)
    private readonly repository: Repository<ChurnPrediction>,
  ) {}

  async findAll(query: any = {}): Promise<ChurnPrediction[]> {
  ...
  async create(data: any): Promise<ChurnPrediction> {
    const entity = this.repository.create(data);
    return this.repository.save(entity);
  }

  async update(id: string, data: any): Promise<ChurnPrediction> {
