...
@Controller('retention-marketing-autopilot')
@UseGuards(JwtAuthGuard)
export class RetentionMarketingAutopilotController {
  constructor(private readonly service: RetentionMarketingAutopilotService) {}
