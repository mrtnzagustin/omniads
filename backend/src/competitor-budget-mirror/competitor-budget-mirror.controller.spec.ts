...
describe('CompetitorBudgetMirrorController', () => {
  let controller: CompetitorBudgetMirrorController;
  let service: jest.Mocked<CompetitorBudgetMirrorService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: CompetitorBudgetMirrorService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<CompetitorBudgetMirrorController>(CompetitorBudgetMirrorController);
    service = module.get(CompetitorBudgetMirrorService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'Competitor budget mirror deleted successfully' });
    });
  });
});
