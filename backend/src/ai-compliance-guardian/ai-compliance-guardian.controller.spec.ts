...
describe('AiComplianceGuardianController', () => {
  let controller: AiComplianceGuardianController;
  let service: jest.Mocked<AiComplianceGuardianService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: AiComplianceGuardianService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<AiComplianceGuardianController>(AiComplianceGuardianController);
    service = module.get(AiComplianceGuardianService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'AI compliance guardian deleted successfully' });
    });
  });
});
