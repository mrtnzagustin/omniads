...
describe('PredictiveChurnRetargetingController', () => {
  let controller: PredictiveChurnRetargetingController;
  let service: jest.Mocked<PredictiveChurnRetargetingService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: PredictiveChurnRetargetingService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<PredictiveChurnRetargetingController>(PredictiveChurnRetargetingController);
    service = module.get(PredictiveChurnRetargetingService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'Predictive churn retargeting deleted successfully' });
    });
  });
});
