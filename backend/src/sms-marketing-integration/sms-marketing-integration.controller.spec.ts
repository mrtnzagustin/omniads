...
describe('SmsMarketingIntegrationController', () => {
  let controller: SmsMarketingIntegrationController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: SmsMarketingIntegrationService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<SmsMarketingIntegrationController>(SmsMarketingIntegrationController);
