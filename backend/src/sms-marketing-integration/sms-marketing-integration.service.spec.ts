...
describe('SmsMarketingIntegrationService', () => {
  let service: SmsMarketingIntegrationService;
  let repository: Repository<SmsMarketingIntegration>;
  ...
  const mockEntity: Partial<SmsMarketingIntegration> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        SmsMarketingIntegrationService,
        {
          provide: getRepositoryToken(SmsMarketingIntegration),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<SmsMarketingIntegrationService>(SmsMarketingIntegrationService);
    repository = module.get<Repository<SmsMarketingIntegration>>(getRepositoryToken(SmsMarketingIntegration));
  });
