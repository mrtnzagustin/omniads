...
describe('AdvancedAbTestFrameworkService', () => {
  let service: AdvancedAbTestFrameworkService;
  let repository: Repository<AdvancedAbTestFramework>;
  ...
  const mockEntity: Partial<AdvancedAbTestFramework> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdvancedAbTestFrameworkService,
        {
          provide: getRepositoryToken(AdvancedAbTestFramework),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<AdvancedAbTestFrameworkService>(AdvancedAbTestFrameworkService);
    repository = module.get<Repository<AdvancedAbTestFramework>>(getRepositoryToken(AdvancedAbTestFramework));
  });
