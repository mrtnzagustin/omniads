...
describe('AdvancedAbTestFrameworkController', () => {
  let controller: AdvancedAbTestFrameworkController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: AdvancedAbTestFrameworkService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<AdvancedAbTestFrameworkController>(AdvancedAbTestFrameworkController);
