...
describe('CustomerJourneyMapperController', () => {
  let controller: CustomerJourneyMapperController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: CustomerJourneyMapperService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<CustomerJourneyMapperController>(CustomerJourneyMapperController);
