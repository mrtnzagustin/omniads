...
describe('CustomerJourneyMapperService', () => {
  let service: CustomerJourneyMapperService;
  let repository: Repository<CustomerJourneyMapper>;
  ...
  const mockEntity: Partial<CustomerJourneyMapper> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CustomerJourneyMapperService,
        {
          provide: getRepositoryToken(CustomerJourneyMapper),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<CustomerJourneyMapperService>(CustomerJourneyMapperService);
    repository = module.get<Repository<CustomerJourneyMapper>>(getRepositoryToken(CustomerJourneyMapper));
  });
