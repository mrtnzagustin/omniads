...
describe('ContextualAiTargetingHubService', () => {
  let service: ContextualAiTargetingHubService;
  let repository: Repository<ContextualProfile>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ContextualAiTargetingHubService,
        {
          provide: getRepositoryToken(ContextualProfile),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<ContextualAiTargetingHubService>(ContextualAiTargetingHubService);
    repository = module.get<Repository<ContextualProfile>>(getRepositoryToken(ContextualProfile));
  });
