...
describe('MultiCurrencyManagerController', () => {
  let controller: MultiCurrencyManagerController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: MultiCurrencyManagerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<MultiCurrencyManagerController>(MultiCurrencyManagerController);
