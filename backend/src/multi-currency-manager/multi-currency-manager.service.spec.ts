...
describe('MultiCurrencyManagerService', () => {
  let service: MultiCurrencyManagerService;
  let repository: Repository<MultiCurrencyManager>;
  ...
  const mockEntity: Partial<MultiCurrencyManager> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        MultiCurrencyManagerService,
        {
          provide: getRepositoryToken(MultiCurrencyManager),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<MultiCurrencyManagerService>(MultiCurrencyManagerService);
    repository = module.get<Repository<MultiCurrencyManager>>(getRepositoryToken(MultiCurrencyManager));
  });
