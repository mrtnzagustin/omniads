...
describe('CrossCampaignSynthesizerController', () => {
  let controller: CrossCampaignSynthesizerController;
  let service: jest.Mocked<CrossCampaignSynthesizerService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: CrossCampaignSynthesizerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<CrossCampaignSynthesizerController>(CrossCampaignSynthesizerController);
    service = module.get(CrossCampaignSynthesizerService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'Cross campaign synthesizer deleted successfully' });
    });
  });
});
