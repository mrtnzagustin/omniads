...
@Controller('api/v1/voice-search-optimization')
@UseGuards(JwtAuthGuard)
export class VoiceSearchOptimizationController {
  constructor(private readonly service: VoiceSearchOptimizationService) {}
