...
describe('EmailAdSyncEngineController', () => {
  let controller: EmailAdSyncEngineController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: EmailAdSyncEngineService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<EmailAdSyncEngineController>(EmailAdSyncEngineController);
