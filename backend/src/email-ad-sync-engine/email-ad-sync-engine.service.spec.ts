...
describe('EmailAdSyncEngineService', () => {
  let service: EmailAdSyncEngineService;
  let repository: Repository<EmailAdSyncEngine>;
  ...
  const mockEntity: Partial<EmailAdSyncEngine> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        EmailAdSyncEngineService,
        {
          provide: getRepositoryToken(EmailAdSyncEngine),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<EmailAdSyncEngineService>(EmailAdSyncEngineService);
    repository = module.get<Repository<EmailAdSyncEngine>>(getRepositoryToken(EmailAdSyncEngine));
  });
