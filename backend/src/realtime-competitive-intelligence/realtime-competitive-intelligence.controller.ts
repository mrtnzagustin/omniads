...
@Controller('realtime-competitive-intelligence')
@UseGuards(JwtAuthGuard)
export class RealtimeCompetitiveIntelligenceController {
  constructor(private readonly service: RealtimeCompetitiveIntelligenceService) {}
