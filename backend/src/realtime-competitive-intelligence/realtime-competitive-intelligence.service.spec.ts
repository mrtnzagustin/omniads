...
describe('RealtimeCompetitiveIntelligenceService', () => {
  let service: RealtimeCompetitiveIntelligenceService;
  let repository: Repository<Competitor>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        RealtimeCompetitiveIntelligenceService,
        {
    ...
    service = module.get<RealtimeCompetitiveIntelligenceService>(RealtimeCompetitiveIntelligenceService);
    repository = module.get<Repository<Competitor>>(getRepositoryToken(Competitor));
  });
