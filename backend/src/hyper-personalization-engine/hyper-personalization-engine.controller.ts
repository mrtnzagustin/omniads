...
@Controller('hyper-personalization-engine')
@UseGuards(JwtAuthGuard)
export class HyperPersonalizationEngineController {
  constructor(private readonly service: HyperPersonalizationEngineService) {}
