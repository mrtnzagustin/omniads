...
describe('HyperPersonalizationEngineService', () => {
  let service: HyperPersonalizationEngineService;
  let repository: Repository<PersonalizationTemplate>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        HyperPersonalizationEngineService,
        {
          provide: getRepositoryToken(PersonalizationTemplate),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<HyperPersonalizationEngineService>(HyperPersonalizationEngineService);
    repository = module.get<Repository<PersonalizationTemplate>>(getRepositoryToken(PersonalizationTemplate));
  });
