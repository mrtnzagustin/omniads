...
describe('MultiObjectiveBalancerController', () => {
  let controller: MultiObjectiveBalancerController;
  let service: jest.Mocked<MultiObjectiveBalancerService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: MultiObjectiveBalancerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<MultiObjectiveBalancerController>(MultiObjectiveBalancerController);
    service = module.get(MultiObjectiveBalancerService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'Multi-objective balancer deleted successfully' });
    });
  });
});
