...
@Controller('predictive-budget-allocator-pro')
@UseGuards(JwtAuthGuard)
export class PredictiveBudgetAllocatorProController {
  constructor(private readonly service: PredictiveBudgetAllocatorProService) {}
