...
describe('PredictiveBudgetAllocatorProService', () => {
  let service: PredictiveBudgetAllocatorProService;
  let repository: Repository<BudgetForecast>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        PredictiveBudgetAllocatorProService,
        {
          provide: getRepositoryToken(BudgetForecast),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<PredictiveBudgetAllocatorProService>(PredictiveBudgetAllocatorProService);
    repository = module.get<Repository<BudgetForecast>>(getRepositoryToken(BudgetForecast));
  });
