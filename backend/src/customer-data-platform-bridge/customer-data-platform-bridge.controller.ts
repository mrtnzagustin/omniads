...
@Controller('customer-data-platform-bridge')
@UseGuards(JwtAuthGuard)
export class CustomerDataPlatformBridgeController {
  constructor(private readonly service: CustomerDataPlatformBridgeService) {}
