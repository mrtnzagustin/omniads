...
describe('CustomerDataPlatformBridgeService', () => {
  let service: CustomerDataPlatformBridgeService;
  let repository: Repository<CDPConnection>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CustomerDataPlatformBridgeService,
        {
          provide: getRepositoryToken(CDPConnection),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<CustomerDataPlatformBridgeService>(CustomerDataPlatformBridgeService);
    repository = module.get<Repository<CDPConnection>>(getRepositoryToken(CDPConnection));
  });
