...
describe('AiCreativeTherapyService', () => {
  let service: AiCreativeTherapyService;
  let repository: Repository<CreativeHealth>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AiCreativeTherapyService,
        {
          provide: getRepositoryToken(CreativeHealth),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<AiCreativeTherapyService>(AiCreativeTherapyService);
    repository = module.get<Repository<CreativeHealth>>(getRepositoryToken(CreativeHealth));
  });
