...
@Controller('campaign-performance-predictor')
@UseGuards(JwtAuthGuard)
export class CampaignPerformancePredictorController {
  constructor(private readonly service: CampaignPerformancePredictorService) {}
