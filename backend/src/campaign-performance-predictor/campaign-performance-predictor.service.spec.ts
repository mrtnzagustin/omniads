...
describe('CampaignPerformancePredictorService', () => {
  let service: CampaignPerformancePredictorService;
  let repository: Repository<CampaignPrediction>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CampaignPerformancePredictorService,
        {
          provide: getRepositoryToken(CampaignPrediction),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<CampaignPerformancePredictorService>(CampaignPerformancePredictorService);
    repository = module.get<Repository<CampaignPrediction>>(getRepositoryToken(CampaignPrediction));
  });
