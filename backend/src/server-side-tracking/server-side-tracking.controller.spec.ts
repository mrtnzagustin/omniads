...
describe('ServerSideTrackingController', () => {
  let controller: ServerSideTrackingController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: ServerSideTrackingService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<ServerSideTrackingController>(ServerSideTrackingController);
