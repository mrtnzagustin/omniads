...
describe('IntelligentFrequencyCapperController', () => {
  let controller: IntelligentFrequencyCapperController;
  let service: jest.Mocked<IntelligentFrequencyCapperService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: IntelligentFrequencyCapperService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<IntelligentFrequencyCapperController>(IntelligentFrequencyCapperController);
    service = module.get(IntelligentFrequencyCapperService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'Intelligent frequency capper deleted successfully' });
    });
  });
});
