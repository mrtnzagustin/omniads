...
describe('MultiPlatformCreativeGeneratorService', () => {
  let service: MultiPlatformCreativeGeneratorService;
  let repository: Repository<MultiPlatformCreativeGenerator>;
  ...
  const mockEntity: Partial<MultiPlatformCreativeGenerator> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        MultiPlatformCreativeGeneratorService,
        {
          provide: getRepositoryToken(MultiPlatformCreativeGenerator),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<MultiPlatformCreativeGeneratorService>(MultiPlatformCreativeGeneratorService);
    repository = module.get<Repository<MultiPlatformCreativeGenerator>>(getRepositoryToken(MultiPlatformCreativeGenerator));
  });
