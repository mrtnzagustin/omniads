...
describe('MultiPlatformCreativeGeneratorController', () => {
  let controller: MultiPlatformCreativeGeneratorController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: MultiPlatformCreativeGeneratorService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<MultiPlatformCreativeGeneratorController>(MultiPlatformCreativeGeneratorController);
