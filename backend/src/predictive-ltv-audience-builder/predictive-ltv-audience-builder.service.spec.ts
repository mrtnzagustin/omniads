...
describe('PredictiveLtvAudienceBuilderService', () => {
  let service: PredictiveLtvAudienceBuilderService;
  let repository: Repository<LTVModel>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        PredictiveLtvAudienceBuilderService,
        {
          provide: getRepositoryToken(LTVModel),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<PredictiveLtvAudienceBuilderService>(PredictiveLtvAudienceBuilderService);
    repository = module.get<Repository<LTVModel>>(getRepositoryToken(LTVModel));
  });
