...
describe('AudienceOverlapAnalyzerController', () => {
  let controller: AudienceOverlapAnalyzerController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: AudienceOverlapAnalyzerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<AudienceOverlapAnalyzerController>(AudienceOverlapAnalyzerController);
