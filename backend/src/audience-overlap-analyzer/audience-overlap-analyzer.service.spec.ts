...
describe('AudienceOverlapAnalyzerService', () => {
  let service: AudienceOverlapAnalyzerService;
  let repository: Repository<AudienceOverlapAnalyzer>;
  ...
  const mockEntity: Partial<AudienceOverlapAnalyzer> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AudienceOverlapAnalyzerService,
        {
          provide: getRepositoryToken(AudienceOverlapAnalyzer),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<AudienceOverlapAnalyzerService>(AudienceOverlapAnalyzerService);
    repository = module.get<Repository<AudienceOverlapAnalyzer>>(getRepositoryToken(AudienceOverlapAnalyzer));
  });
