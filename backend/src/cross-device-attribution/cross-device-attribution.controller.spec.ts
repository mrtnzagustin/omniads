...
describe('CrossDeviceAttributionController', () => {
  let controller: CrossDeviceAttributionController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: CrossDeviceAttributionService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<CrossDeviceAttributionController>(CrossDeviceAttributionController);
