...
describe('GenerativeAiCreativeStudioService', () => {
  let service: GenerativeAiCreativeStudioService;
  let repository: Repository<GenerativeAiCreativeStudio>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        GenerativeAiCreativeStudioService,
        {
          provide: getRepositoryToken(GenerativeAiCreativeStudio),
    ...
    repository = module.get<Repository<GenerativeAiCreativeStudio>>(getRepositoryToken(GenerativeAiCreativeStudio));
  });
