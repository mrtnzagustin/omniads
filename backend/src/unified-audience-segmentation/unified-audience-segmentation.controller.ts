...
@Controller('unified-audience-segmentation')
@UseGuards(JwtAuthGuard)
export class UnifiedAudienceSegmentationController {
  constructor(private readonly service: UnifiedAudienceSegmentationService) {}
