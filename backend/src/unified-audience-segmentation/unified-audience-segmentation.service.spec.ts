...
describe('UnifiedAudienceSegmentationService', () => {
  let service: UnifiedAudienceSegmentationService;
  let repository: Repository<UnifiedAudience>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        UnifiedAudienceSegmentationService,
        {
          provide: getRepositoryToken(UnifiedAudience),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<UnifiedAudienceSegmentationService>(UnifiedAudienceSegmentationService);
    repository = module.get<Repository<UnifiedAudience>>(getRepositoryToken(UnifiedAudience));
  });
