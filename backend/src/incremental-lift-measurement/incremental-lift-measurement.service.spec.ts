...
describe('IncrementalLiftMeasurementService', () => {
  let service: IncrementalLiftMeasurementService;
  let repository: Repository<IncrementalLiftMeasurement>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        IncrementalLiftMeasurementService,
        {
          provide: getRepositoryToken(IncrementalLiftMeasurement),
    ...
    repository = module.get<Repository<IncrementalLiftMeasurement>>(getRepositoryToken(IncrementalLiftMeasurement));
  });
