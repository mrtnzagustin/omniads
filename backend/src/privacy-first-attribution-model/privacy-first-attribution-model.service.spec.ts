...
describe('PrivacyFirstAttributionModelService', () => {
  let service: PrivacyFirstAttributionModelService;
  let repository: Repository<AttributionModel095>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        PrivacyFirstAttributionModelService,
        {
          provide: getRepositoryToken(AttributionModel095),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<PrivacyFirstAttributionModelService>(PrivacyFirstAttributionModelService);
    repository = module.get<Repository<AttributionModel095>>(getRepositoryToken(AttributionModel095));
  });
