...
describe('InfluencerCampaignManagerService', () => {
  let service: InfluencerCampaignManagerService;
  let repository: Repository<InfluencerCampaignManager>;
  ...
  const mockEntity: Partial<InfluencerCampaignManager> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        InfluencerCampaignManagerService,
        {
          provide: getRepositoryToken(InfluencerCampaignManager),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<InfluencerCampaignManagerService>(InfluencerCampaignManagerService);
    repository = module.get<Repository<InfluencerCampaignManager>>(getRepositoryToken(InfluencerCampaignManager));
  });
