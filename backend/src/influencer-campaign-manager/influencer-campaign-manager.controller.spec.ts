...
describe('InfluencerCampaignManagerController', () => {
  let controller: InfluencerCampaignManagerController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: InfluencerCampaignManagerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<InfluencerCampaignManagerController>(InfluencerCampaignManagerController);
