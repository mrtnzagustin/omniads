...
@Controller('api/v1/real-time-bid-optimization')
@UseGuards(JwtAuthGuard)
export class RealTimeBidOptimizationController {
  constructor(private readonly service: RealTimeBidOptimizationService) {}
