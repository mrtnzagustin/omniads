...
@Controller('micro-influencer-discovery-ai')
@UseGuards(JwtAuthGuard)
export class MicroInfluencerDiscoveryAiController {
  constructor(private readonly service: MicroInfluencerDiscoveryAiService) {}
