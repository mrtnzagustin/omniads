...
describe('BudgetPacingControllerController', () => {
  let controller: BudgetPacingControllerController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: BudgetPacingControllerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<BudgetPacingControllerController>(BudgetPacingControllerController);
