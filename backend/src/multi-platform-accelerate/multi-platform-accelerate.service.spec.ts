...
describe('MultiPlatformAccelerateService', () => {
  let service: MultiPlatformAccelerateService;
  let repository: Repository<AccelerateCampaign>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        MultiPlatformAccelerateService,
        {
          provide: getRepositoryToken(AccelerateCampaign),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<MultiPlatformAccelerateService>(MultiPlatformAccelerateService);
    repository = module.get<Repository<AccelerateCampaign>>(getRepositoryToken(AccelerateCampaign));
  });
