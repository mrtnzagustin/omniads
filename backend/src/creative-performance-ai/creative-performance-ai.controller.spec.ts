...
describe('CreativePerformanceAiController', () => {
  let controller: CreativePerformanceAiController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: CreativePerformanceAiService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<CreativePerformanceAiController>(CreativePerformanceAiController);
