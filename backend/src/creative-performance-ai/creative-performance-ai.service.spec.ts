...
describe('CreativePerformanceAiService', () => {
  let service: CreativePerformanceAiService;
  let repository: Repository<CreativePerformanceAi>;
  ...
  const mockEntity: Partial<CreativePerformanceAi> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CreativePerformanceAiService,
        {
          provide: getRepositoryToken(CreativePerformanceAi),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<CreativePerformanceAiService>(CreativePerformanceAiService);
    repository = module.get<Repository<CreativePerformanceAi>>(getRepositoryToken(CreativePerformanceAi));
  });
