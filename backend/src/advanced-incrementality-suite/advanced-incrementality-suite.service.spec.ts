...
describe('AdvancedIncrementalitySuiteService', () => {
  let service: AdvancedIncrementalitySuiteService;
  let repository: Repository<IncrementalityExperiment>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdvancedIncrementalitySuiteService,
        {
          provide: getRepositoryToken(IncrementalityExperiment),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<AdvancedIncrementalitySuiteService>(AdvancedIncrementalitySuiteService);
    repository = module.get<Repository<IncrementalityExperiment>>(getRepositoryToken(IncrementalityExperiment));
  });
