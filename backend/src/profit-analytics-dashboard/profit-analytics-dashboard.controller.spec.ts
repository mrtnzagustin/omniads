...
describe('ProfitAnalyticsDashboardController', () => {
  let controller: ProfitAnalyticsDashboardController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: ProfitAnalyticsDashboardService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<ProfitAnalyticsDashboardController>(ProfitAnalyticsDashboardController);
