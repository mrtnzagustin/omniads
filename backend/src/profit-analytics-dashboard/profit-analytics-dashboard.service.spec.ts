...
describe('ProfitAnalyticsDashboardService', () => {
  let service: ProfitAnalyticsDashboardService;
  let repository: Repository<ProfitAnalyticsDashboard>;
  ...
  const mockEntity: Partial<ProfitAnalyticsDashboard> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ProfitAnalyticsDashboardService,
        {
          provide: getRepositoryToken(ProfitAnalyticsDashboard),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<ProfitAnalyticsDashboardService>(ProfitAnalyticsDashboardService);
    repository = module.get<Repository<ProfitAnalyticsDashboard>>(getRepositoryToken(ProfitAnalyticsDashboard));
  });
