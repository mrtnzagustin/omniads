...
describe('AiSeasonalityPlannerController', () => {
  let controller: AiSeasonalityPlannerController;
  let service: jest.Mocked<AiSeasonalityPlannerService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: AiSeasonalityPlannerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<AiSeasonalityPlannerController>(AiSeasonalityPlannerController);
    service = module.get(AiSeasonalityPlannerService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'AI seasonality planner deleted successfully' });
    });
  });
});
