...
describe('SmartCampaignClonerController', () => {
  let controller: SmartCampaignClonerController;
  let service: jest.Mocked<SmartCampaignClonerService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: SmartCampaignClonerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<SmartCampaignClonerController>(SmartCampaignClonerController);
    service = module.get(SmartCampaignClonerService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'Smart campaign cloner deleted successfully' });
    });
  });
});
