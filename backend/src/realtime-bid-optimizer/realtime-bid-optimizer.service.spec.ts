...
describe('RealtimeBidOptimizerService', () => {
  let service: RealtimeBidOptimizerService;
  let repository: Repository<RealtimeBidOptimizer>;
  ...
  const mockEntity: Partial<RealtimeBidOptimizer> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        RealtimeBidOptimizerService,
        {
          provide: getRepositoryToken(RealtimeBidOptimizer),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<RealtimeBidOptimizerService>(RealtimeBidOptimizerService);
    repository = module.get<Repository<RealtimeBidOptimizer>>(getRepositoryToken(RealtimeBidOptimizer));
  });
