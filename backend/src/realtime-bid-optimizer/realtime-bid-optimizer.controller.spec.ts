...
describe('RealtimeBidOptimizerController', () => {
  let controller: RealtimeBidOptimizerController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: RealtimeBidOptimizerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<RealtimeBidOptimizerController>(RealtimeBidOptimizerController);
