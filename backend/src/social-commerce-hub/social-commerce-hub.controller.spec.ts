...
describe('SocialCommerceHubController', () => {
  let controller: SocialCommerceHubController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: SocialCommerceHubService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<SocialCommerceHubController>(SocialCommerceHubController);
