...
describe('SocialCommerceHubService', () => {
  let service: SocialCommerceHubService;
  let repository: Repository<SocialCommerceHub>;
  ...
  const mockEntity: Partial<SocialCommerceHub> = {
    id: '123',
    userId: 'user1',
    name: 'Test Entity',
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        SocialCommerceHubService,
        {
          provide: getRepositoryToken(SocialCommerceHub),
          useValue: mockRepository,
        },
      ],
    }).compile();

    service = module.get<SocialCommerceHubService>(SocialCommerceHubService);
    repository = module.get<Repository<SocialCommerceHub>>(getRepositoryToken(SocialCommerceHub));
  });
