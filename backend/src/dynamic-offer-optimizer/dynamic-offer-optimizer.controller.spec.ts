...
describe('DynamicOfferOptimizerController', () => {
  let controller: DynamicOfferOptimizerController;
  let service: jest.Mocked<DynamicOfferOptimizerService>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: DynamicOfferOptimizerService,
          useValue: mockService,
        },
      ],
    }).compile();

    controller = module.get<DynamicOfferOptimizerController>(DynamicOfferOptimizerController);
    service = module.get(DynamicOfferOptimizerService);
  });
  ...
  describe('delete', () => {
    it('should call service and return success message', async () => {
      ...
      expect(result).toEqual({ message: 'Dynamic offer optimizer deleted successfully' });
    });
  });
});
