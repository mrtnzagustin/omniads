# Tasks: Subscription FEATURE_TITLE Retention Analytics

**Feature**: 067-subscription-retention-analytics
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/067-subscription-retention-analytics/`
...
**Acceptance Criteria**:
- [ ] Create SubscriptionMetric TypeORM entity with all required columns
- [ ] Create ChurnAnalysis TypeORM entity with all required columns
- [ ] Create MRRTracking TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/subscriptionmetric.entity.ts`
- Entity file exists at `backend/src/database/entities/churnanalysis.entity.ts`
- Entity file exists at `backend/src/database/entities/mrrtracking.entity.ts`
