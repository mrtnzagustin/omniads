# Tasks: Customer Journey Mapper

**Feature**: 133-customer-journey-mapper
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/133-customer-journey-mapper/`
...
**Acceptance Criteria**:
- [ ] Create customerjourneymapperConfig TypeORM entity with all required columns
- [ ] Create customerjourneymapperActivity TypeORM entity with all required columns
- [ ] Create customerjourneymapperMetrics TypeORM entity with all required columns
- [ ] Create customerjourneymapperOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/customerjourneymapperconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/customerjourneymapperactivity.entity.ts`
- Entity file exists at `backend/src/database/entities/customerjourneymappermetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/customerjourneymapperoutcome.entity.ts`
