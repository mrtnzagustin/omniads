# Tasks: Audience Overlap Analyzer

**Feature**: 146-audience-overlap-analyzer
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/146-audience-overlap-analyzer/`
...
**Acceptance Criteria**:
- [ ] Create audienceoverlapanalyzerConfig TypeORM entity with all required columns
- [ ] Create audienceoverlapanalyzerActivity TypeORM entity with all required columns
- [ ] Create audienceoverlapanalyzerMetrics TypeORM entity with all required columns
- [ ] Create audienceoverlapanalyzerOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/audienceoverlapanalyzerconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/audienceoverlapanalyzeractivity.entity.ts`
- Entity file exists at `backend/src/database/entities/audienceoverlapanalyzermetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/audienceoverlapanalyzeroutcome.entity.ts`
