...
**Module Structure**:
```
backend/src/120-intelligent-frequency-capper/
├── 120-intelligent-frequency-capper.module.ts
├── 120-intelligent-frequency-capper.service.ts
├── 120-intelligent-frequency-capper.controller.ts
├── dto/
│   ├── create-120-intelligent-frequency-capper.dto.ts
│   └── update-120-intelligent-frequency-capper.dto.ts
└── entities/
```
