# Tasks: Data Warehouse Connector

**Feature**: 142-data-warehouse-connector
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/142-data-warehouse-connector/`
...
**Acceptance Criteria**:
- [ ] Create datawarehouseconnectorConfig TypeORM entity with all required columns
- [ ] Create datawarehouseconnectorActivity TypeORM entity with all required columns
- [ ] Create datawarehouseconnectorMetrics TypeORM entity with all required columns
- [ ] Create datawarehouseconnectorOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/datawarehouseconnectorconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/datawarehouseconnectoractivity.entity.ts`
- Entity file exists at `backend/src/database/entities/datawarehouseconnectormetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/datawarehouseconnectoroutcome.entity.ts`
