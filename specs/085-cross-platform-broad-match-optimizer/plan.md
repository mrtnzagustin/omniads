...
**Feature**: 085-cross-platform-broad-match-optimizer
...
**Module Structure**:
```
backend/src/085-cross-platform-broad-match-optimizer/
├── 085-cross-platform-broad-match-optimizer.module.ts
├── 085-cross-platform-broad-match-optimizer.service.ts
├── 085-cross-platform-broad-match-optimizer.controller.ts
├── dto/
│   ├── create-085-cross-platform-broad-match-optimizer.dto.ts
│   └── update-085-cross-platform-broad-match-optimizer.dto.ts
└── entities/
    ├── crossconfig.entity.ts
    ├── crossresult.entity.ts
    ├── crosshistory.entity.ts
```
...
```typescript
@Entity('crosshistorys')
export class CrossHistory {
  @PrimaryGeneratedColumn('uuid')
  id: string;
