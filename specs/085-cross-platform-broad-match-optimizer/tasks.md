...
**Input**: Design documents from `specs/085-cross-platform-broad-match-optimizer/`
...
**Acceptance Criteria**:
- [ ] Create CrossConfig TypeORM entity with all required columns
- [ ] Create CrossResult TypeORM entity with all required columns
- [ ] Create CrossHistory TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/crossconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/crossresult.entity.ts`
- Entity file exists at `backend/src/database/entities/crosshistory.entity.ts`
