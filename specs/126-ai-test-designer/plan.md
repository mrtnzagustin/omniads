...
**Module Structure**:
```
backend/src/126-ai-test-designer/
├── 126-ai-test-designer.module.ts
├── 126-ai-test-designer.service.ts
├── 126-ai-test-designer.controller.ts
├── dto/
│   ├── create-126-ai-test-designer.dto.ts
│   └── update-126-ai-test-designer.dto.ts
└── entities/
```
