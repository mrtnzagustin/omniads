# Tasks: Creative Performance AI

**Feature**: 144-creative-performance-ai
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/144-creative-performance-ai/`
...
**Acceptance Criteria**:
- [ ] Create creativeperformanceaiConfig TypeORM entity with all required columns
- [ ] Create creativeperformanceaiActivity TypeORM entity with all required columns
- [ ] Create creativeperformanceaiMetrics TypeORM entity with all required columns
- [ ] Create creativeperformanceaiOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/creativeperformanceaiconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/creativeperformanceaiactivity.entity.ts`
- Entity file exists at `backend/src/database/entities/creativeperformanceaimetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/creativeperformanceaioutcome.entity.ts`
