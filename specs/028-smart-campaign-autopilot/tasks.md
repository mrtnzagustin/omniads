# Tasks: Smart Campaign Autopilot

**Feature**: 028-smart-campaign-autopilot
**Created**: 2025-11-06
**Status**: Implemented

**Input**: Design documents from `specs/028-smart-campaign-autopilot/`
...
**Acceptance Criteria**:
- [ ] Create AutopilotConfig TypeORM entity with all required columns
- [ ] Create AutopilotDecision TypeORM entity with all required columns
- [ ] Create AutopilotMetrics TypeORM entity with all required columns
- [ ] Create AutopilotOverride TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/autopilotconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/autopilotdecision.entity.ts`
- Entity file exists at `backend/src/database/entities/autopilotmetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/autopilotoverride.entity.ts`
