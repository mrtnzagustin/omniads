# Tasks: Profit Analytics Dashboard

**Feature**: 130-profit-analytics-dashboard
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/130-profit-analytics-dashboard/`
...
**Acceptance Criteria**:
- [ ] Create profitanalyticsdashboardConfig TypeORM entity with all required columns
- [ ] Create profitanalyticsdashboardActivity TypeORM entity with all required columns
- [ ] Create profitanalyticsdashboardMetrics TypeORM entity with all required columns
- [ ] Create profitanalyticsdashboardOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/profitanalyticsdashboardconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/profitanalyticsdashboardactivity.entity.ts`
- Entity file exists at `backend/src/database/entities/profitanalyticsdashboardmetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/profitanalyticsdashboardoutcome.entity.ts`
