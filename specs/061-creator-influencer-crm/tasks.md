# Tasks: Creator FEATURE_TITLE Influencer CRM

**Feature**: 061-creator-influencer-crm
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/061-creator-influencer-crm/`
...
- [ ] Create InfluencerPost TypeORM entity with all required columns
...
- Entity file exists at `backend/src/database/entities/influencerpost.entity.ts`
