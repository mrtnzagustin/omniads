...
**Input**: Design documents from `specs/051-privacy-first-analytics-hub/`
...
**Acceptance Criteria**:
- [ ] Create PrivacyTrackingSession TypeORM entity with all required columns
- [ ] Create FirstPartyEvent TypeORM entity with all required columns
- [ ] Create ConsentConfiguration TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/privacytrackingsession.entity.ts`
- Entity file exists at `backend/src/database/entities/firstpartyevent.entity.ts`
- Entity file exists at `backend/src/database/entities/consentconfiguration.entity.ts`
