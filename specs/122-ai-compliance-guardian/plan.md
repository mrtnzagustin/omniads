...
**Module Structure**:
```
backend/src/122-ai-compliance-guardian/
├── 122-ai-compliance-guardian.module.ts
├── 122-ai-compliance-guardian.service.ts
├── 122-ai-compliance-guardian.controller.ts
├── dto/
│   ├── create-122-ai-compliance-guardian.dto.ts
│   └── update-122-ai-compliance-guardian.dto.ts
└── entities/
```
