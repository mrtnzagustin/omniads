...
**Module Structure**:
```
backend/src/119-multi-objective-balancer/
├── 119-multi-objective-balancer.module.ts
├── 119-multi-objective-balancer.service.ts
├── 119-multi-objective-balancer.controller.ts
├── dto/
│   ├── create-119-multi-objective-balancer.dto.ts
│   └── update-119-multi-objective-balancer.dto.ts
└── entities/
```
