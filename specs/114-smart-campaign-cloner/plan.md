...
**Module Structure**:
```
backend/src/114-smart-campaign-cloner/
├── 114-smart-campaign-cloner.module.ts
├── 114-smart-campaign-cloner.service.ts
├── 114-smart-campaign-cloner.controller.ts
├── dto/
│   ├── create-114-smart-campaign-cloner.dto.ts
│   └── update-114-smart-campaign-cloner.dto.ts
└── entities/
```
