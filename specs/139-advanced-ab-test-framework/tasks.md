...
**Input**: Design documents from `specs/139-advanced-ab-test-framework/`
...
**Acceptance Criteria**:
- [ ] Create advancedabtestframeworkConfig TypeORM entity with all required columns
- [ ] Create advancedabtestframeworkActivity TypeORM entity with all required columns
- [ ] Create advancedabtestframeworkMetrics TypeORM entity with all required columns
- [ ] Create advancedabtestframeworkOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/advancedabtestframeworkconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/advancedabtestframeworkactivity.entity.ts`
- Entity file exists at `backend/src/database/entities/advancedabtestframeworkmetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/advancedabtestframeworkoutcome.entity.ts`
