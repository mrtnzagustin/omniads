...
**Input**: Design documents from `specs/087-first-party-data-enrichment-hub/`
...
**Acceptance Criteria**:
- [ ] Create FirstConfig TypeORM entity with all required columns
- [ ] Create FirstResult TypeORM entity with all required columns
- [ ] Create FirstHistory TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/firstconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/firstresult.entity.ts`
- Entity file exists at `backend/src/database/entities/firsthistory.entity.ts`
