...
**Module Structure**:
```
backend/src/124-cross-campaign-synthesizer/
├── 124-cross-campaign-synthesizer.module.ts
├── 124-cross-campaign-synthesizer.service.ts
├── 124-cross-campaign-synthesizer.controller.ts
├── dto/
│   ├── create-124-cross-campaign-synthesizer.dto.ts
│   └── update-124-cross-campaign-synthesizer.dto.ts
└── entities/
```
