...
**Module Structure**:
```
backend/src/117-creative-element-mixer/
├── 117-creative-element-mixer.module.ts
├── 117-creative-element-mixer.service.ts
├── 117-creative-element-mixer.controller.ts
├── dto/
│   ├── create-117-creative-element-mixer.dto.ts
│   └── update-117-creative-element-mixer.dto.ts
└── entities/
```
