# Tasks: Advanced Incrementality Suite

**Feature**: 094-advanced-incrementality-suite
**Created**: 2025-11-06
**Status**: Implemented

**Input**: Design documents from `specs/094-advanced-incrementality-suite/`
...
**Acceptance Criteria**:
- [ ] Create IncrementalityExperiment TypeORM entity with all required columns
- [ ] Create TreatmentGroup TypeORM entity with all required columns
- [ ] Create ControlGroup TypeORM entity with all required columns
- [ ] Create ExperimentResult TypeORM entity with all required columns
- [ ] Create SyntheticControl TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/incrementalityexperiment.entity.ts`
- Entity file exists at `backend/src/database/entities/treatmentgroup.entity.ts`
- Entity file exists at `backend/src/database/entities/controlgroup.entity.ts`
- Entity file exists at `backend/src/database/entities/experimentresult.entity.ts`
- Entity file exists at `backend/src/database/entities/syntheticcontrol.entity.ts`
