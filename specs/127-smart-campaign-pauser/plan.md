...
**Module Structure**:
```
backend/src/127-smart-campaign-pauser/
├── 127-smart-campaign-pauser.module.ts
├── 127-smart-campaign-pauser.service.ts
├── 127-smart-campaign-pauser.controller.ts
├── dto/
│   ├── create-127-smart-campaign-pauser.dto.ts
│   └── update-127-smart-campaign-pauser.dto.ts
└── entities/
```
