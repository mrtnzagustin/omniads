...
**Module Structure**:
```
backend/src/125-dynamic-offer-optimizer/
├── 125-dynamic-offer-optimizer.module.ts
├── 125-dynamic-offer-optimizer.service.ts
├── 125-dynamic-offer-optimizer.controller.ts
├── dto/
│   ├── create-125-dynamic-offer-optimizer.dto.ts
│   └── update-125-dynamic-offer-optimizer.dto.ts
└── entities/
```
