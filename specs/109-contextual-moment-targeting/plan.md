...
**Module Structure**:
```
backend/src/109-contextual-moment-targeting/
├── 109-contextual-moment-targeting.module.ts
├── 109-contextual-moment-targeting.service.ts
├── 109-contextual-moment-targeting.controller.ts
├── dto/
│   ├── create-109-contextual-moment-targeting.dto.ts
│   └── update-109-contextual-moment-targeting.dto.ts
└── entities/
```
