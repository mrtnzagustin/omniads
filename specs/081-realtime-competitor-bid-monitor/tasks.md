...
**Input**: Design documents from `specs/081-realtime-competitor-bid-monitor/`
...
**Acceptance Criteria**:
- [ ] Create RealConfig TypeORM entity with all required columns
- [ ] Create RealResult TypeORM entity with all required columns
- [ ] Create RealHistory TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/realconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/realresult.entity.ts`
- Entity file exists at `backend/src/database/entities/realhistory.entity.ts`
