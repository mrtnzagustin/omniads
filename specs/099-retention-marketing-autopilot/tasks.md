# Tasks: Retention Marketing Autopilot

**Feature**: 099-retention-marketing-autopilot
**Created**: 2025-11-06
**Status**: Implemented

**Input**: Design documents from `specs/099-retention-marketing-autopilot/`
...
**Acceptance Criteria**:
- [ ] Create ChurnPrediction TypeORM entity with all required columns
- [ ] Create LifecycleStage TypeORM entity with all required columns
- [ ] Create RetentionCampaign TypeORM entity with all required columns
- [ ] Create WinBackOffer TypeORM entity with all required columns
- [ ] Create CustomerJourney TypeORM entity with all required columns
- [ ] Create RetentionMetrics TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/churnprediction.entity.ts`
- Entity file exists at `backend/src/database/entities/lifecyclestage.entity.ts`
- Entity file exists at `backend/src/database/entities/retentioncampaign.entity.ts`
- Entity file exists at `backend/src/database/entities/winbackoffer.entity.ts`
- Entity file exists at `backend/src/database/entities/customerjourney.entity.ts`
- Entity file exists at `backend/src/database/entities/retentionmetrics.entity.ts`
