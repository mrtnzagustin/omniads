# Tasks: Privacy-First Attribution Model

**Feature**: 095-privacy-first-attribution-model
**Created**: 2025-11-06
**Status**: Implemented

**Input**: Design documents from `specs/095-privacy-first-attribution-model/`
...
- [ ] Create ModeledConversion TypeORM entity with all required columns
- [ ] Create AttributionCalibration TypeORM entity with all required columns
...
- Entity file exists at `backend/src/database/entities/modeledconversion.entity.ts`
- Entity file exists at `backend/src/database/entities/attributioncalibration.entity.ts`
