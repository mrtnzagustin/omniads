# Tasks: Zero-Party Data Collection Hub

**Feature**: 030-zero-party-data-hub
**Created**: 2025-11-06
**Status**: Implemented

**Input**: Design documents from `specs/030-zero-party-data-hub/`
...
**Acceptance Criteria**:
- [ ] Create DataCollectionForm TypeORM entity with all required columns
- [ ] Create ZeroPartyData TypeORM entity with all required columns
- [ ] Create ConsentRecord TypeORM entity with all required columns
- [ ] Create PreferenceCenter TypeORM entity with all required columns
- [ ] Create DataSegment TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/datacollectionform.entity.ts`
- Entity file exists at `backend/src/database/entities/zeropartydata.entity.ts`
- Entity file exists at `backend/src/database/entities/consentrecord.entity.ts`
- Entity file exists at `backend/src/database/entities/preferencecenter.entity.ts`
- Entity file exists at `backend/src/database/entities/datasegment.entity.ts`
