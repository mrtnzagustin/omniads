...
**Input**: Design documents from `specs/049-real-time-bid-optimization/`
...
**Acceptance Criteria**:
- [ ] Create BidOptimizationRule TypeORM entity with all required columns
- [ ] Create BidAdjustmentHistory TypeORM entity with all required columns
- [ ] Create BidPerformanceMetrics TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/bidoptimizationrule.entity.ts`
- Entity file exists at `backend/src/database/entities/bidadjustmenthistory.entity.ts`
- Entity file exists at `backend/src/database/entities/bidperformancemetrics.entity.ts`
