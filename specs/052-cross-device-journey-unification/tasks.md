...
**Input**: Design documents from `specs/052-cross-device-journey-unification/`
...
- [ ] Create CrossDeviceJourney TypeORM entity with all required columns
- [ ] Create DeviceIdentityResolution TypeORM entity with all required columns
...
- Entity file exists at `backend/src/database/entities/crossdevicejourney.entity.ts`
- Entity file exists at `backend/src/database/entities/deviceidentityresolution.entity.ts`
