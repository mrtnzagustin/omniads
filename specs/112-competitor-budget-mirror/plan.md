...
**Module Structure**:
```
backend/src/112-competitor-budget-mirror/
├── 112-competitor-budget-mirror.module.ts
├── 112-competitor-budget-mirror.service.ts
├── 112-competitor-budget-mirror.controller.ts
├── dto/
│   ├── create-112-competitor-budget-mirror.dto.ts
│   └── update-112-competitor-budget-mirror.dto.ts
└── entities/
```
