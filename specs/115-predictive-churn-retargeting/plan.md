...
**Module Structure**:
```
backend/src/115-predictive-churn-retargeting/
├── 115-predictive-churn-retargeting.module.ts
├── 115-predictive-churn-retargeting.service.ts
├── 115-predictive-churn-retargeting.controller.ts
├── dto/
│   ├── create-115-predictive-churn-retargeting.dto.ts
│   └── update-115-predictive-churn-retargeting.dto.ts
└── entities/
```
