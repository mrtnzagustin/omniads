# Tasks: Sustainability FEATURE_TITLE Carbon Tracking

**Feature**: 059-sustainability-carbon-tracking
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/059-sustainability-carbon-tracking/`
...
**Acceptance Criteria**:
- [ ] Create CarbonFootprint TypeORM entity with all required columns
- [ ] Create SustainabilityMetric TypeORM entity with all required columns
- [ ] Create CarbonReductionGoal TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/carbonfootprint.entity.ts`
- Entity file exists at `backend/src/database/entities/sustainabilitymetric.entity.ts`
- Entity file exists at `backend/src/database/entities/carbonreductiongoal.entity.ts`
