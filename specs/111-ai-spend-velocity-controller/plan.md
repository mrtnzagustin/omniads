...
**Module Structure**:
```
backend/src/111-ai-spend-velocity-controller/
├── 111-ai-spend-velocity-controller.module.ts
├── 111-ai-spend-velocity-controller.service.ts
├── 111-ai-spend-velocity-controller.controller.ts
├── dto/
│   ├── create-111-ai-spend-velocity-controller.dto.ts
│   └── update-111-ai-spend-velocity-controller.dto.ts
└── entities/
```
