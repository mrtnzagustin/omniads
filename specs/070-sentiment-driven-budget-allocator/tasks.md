...
**Input**: Design documents from `specs/070-sentiment-driven-budget-allocator/`
...
**Acceptance Criteria**:
- [ ] Create SentimentConfig TypeORM entity with all required columns
- [ ] Create SentimentResult TypeORM entity with all required columns
- [ ] Create SentimentHistory TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/sentimentconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/sentimentresult.entity.ts`
- Entity file exists at `backend/src/database/entities/sentimenthistory.entity.ts`
