# Tasks: AI Creative Therapy

**Feature**: 096-ai-creative-therapy
**Created**: 2025-11-06
**Status**: Implemented

**Input**: Design documents from `specs/096-ai-creative-therapy/`
...
**Acceptance Criteria**:
- [ ] Create CreativeHealth TypeORM entity with all required columns
- [ ] Create FatigueDiagnosis TypeORM entity with all required columns
- [ ] Create RefreshPrescription TypeORM entity with all required columns
- [ ] Create CreativeLifecycle TypeORM entity with all required columns
- [ ] Create RefreshExperiment TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/creativehealth.entity.ts`
- Entity file exists at `backend/src/database/entities/fatiguediagnosis.entity.ts`
- Entity file exists at `backend/src/database/entities/refreshprescription.entity.ts`
- Entity file exists at `backend/src/database/entities/creativelifecycle.entity.ts`
- Entity file exists at `backend/src/database/entities/refreshexperiment.entity.ts`
