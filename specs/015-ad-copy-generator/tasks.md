# Tasks: AI Ad Copy Generator & Optimizer

**Feature**: 015-ad-copy-generator
**Created**: 2025-11-06
**Status**: Implemented

**Input**: Design documents from `specs/015-ad-copy-generator/`
...
**Acceptance Criteria**:
- [ ] Create AdCopyRequest TypeORM entity with all required columns
- [ ] Create AdCopyVariant TypeORM entity with all required columns
- [ ] Create AdCopyPattern TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/adcopyrequest.entity.ts`
- Entity file exists at `backend/src/database/entities/adcopyvariant.entity.ts`
- Entity file exists at `backend/src/database/entities/adcopypattern.entity.ts`
