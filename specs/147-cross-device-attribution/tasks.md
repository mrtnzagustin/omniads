# Tasks: Cross-Device Attribution

**Feature**: 147-cross-device-attribution
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/147-cross-device-attribution/`
...
**Acceptance Criteria**:
- [ ] Create crossdeviceattributionConfig TypeORM entity with all required columns
- [ ] Create crossdeviceattributionActivity TypeORM entity with all required columns
- [ ] Create crossdeviceattributionMetrics TypeORM entity with all required columns
- [ ] Create crossdeviceattributionOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/crossdeviceattributionconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/crossdeviceattributionactivity.entity.ts`
- Entity file exists at `backend/src/database/entities/crossdeviceattributionmetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/crossdeviceattributionoutcome.entity.ts`
