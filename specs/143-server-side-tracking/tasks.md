# Tasks: Server-Side Tracking

**Feature**: 143-server-side-tracking
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/143-server-side-tracking/`
...
**Acceptance Criteria**:
- [ ] Create serversidetrackingConfig TypeORM entity with all required columns
- [ ] Create serversidetrackingActivity TypeORM entity with all required columns
- [ ] Create serversidetrackingMetrics TypeORM entity with all required columns
- [ ] Create serversidetrackingOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/serversidetrackingconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/serversidetrackingactivity.entity.ts`
- Entity file exists at `backend/src/database/entities/serversidetrackingmetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/serversidetrackingoutcome.entity.ts`
