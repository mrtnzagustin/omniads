# Tasks: Predictive LTV Segments

**Feature**: 134-predictive-ltv-segments
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/134-predictive-ltv-segments/`
...
**Acceptance Criteria**:
- [ ] Create predictiveltvsegmentsConfig TypeORM entity with all required columns
- [ ] Create predictiveltvsegmentsActivity TypeORM entity with all required columns
- [ ] Create predictiveltvsegmentsMetrics TypeORM entity with all required columns
- [ ] Create predictiveltvsegmentsOutcome TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/predictiveltvsegmentsconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/predictiveltvsegmentsactivity.entity.ts`
- Entity file exists at `backend/src/database/entities/predictiveltvsegmentsmetrics.entity.ts`
- Entity file exists at `backend/src/database/entities/predictiveltvsegmentsoutcome.entity.ts`
