# Tasks: Streaming FEATURE_TITLE Podcast Ad Manager

**Feature**: 056-streaming-podcast-ad-manager
**Created**: 2025-11-06
**Status**: Draft

**Input**: Design documents from `specs/056-streaming-podcast-ad-manager/`
...
**Acceptance Criteria**:
- [ ] Create PodcastCampaign TypeORM entity with all required columns
- [ ] Create AudioAdCreative TypeORM entity with all required columns
- [ ] Create PodcastPlacement TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/podcastcampaign.entity.ts`
- Entity file exists at `backend/src/database/entities/audioadcreative.entity.ts`
- Entity file exists at `backend/src/database/entities/podcastplacement.entity.ts`
