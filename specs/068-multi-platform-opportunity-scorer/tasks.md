...
**Input**: Design documents from `specs/068-multi-platform-opportunity-scorer/`
...
**Acceptance Criteria**:
- [ ] Create MultiConfig TypeORM entity with all required columns
- [ ] Create MultiResult TypeORM entity with all required columns
- [ ] Create MultiHistory TypeORM entity with all required columns
...
**Definition of Done**:
- Entity file exists at `backend/src/database/entities/multiconfig.entity.ts`
- Entity file exists at `backend/src/database/entities/multiresult.entity.ts`
- Entity file exists at `backend/src/database/entities/multihistory.entity.ts`
